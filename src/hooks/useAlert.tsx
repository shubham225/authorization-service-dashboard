...
export const useAlert = () => {
    ...
    const showAlert = (message: string, type: TAlertSeverity, title : string) : void => {
        let alert : TAlert = {
            open : true,
            message: message,
        ...
        if(setAppContext != null) {
           setAppContext((context) => {return {...context, alert : alert}});
        }
    }
    ...
    const closeAlert = (
        ...
        if(setAppContext != null) {
            setAppContext((context) => {return {...context, alert : initAlert}});
        }
    }
